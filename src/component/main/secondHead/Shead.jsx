                    ...
                    <div className="user info" style={{ fontSize: "24px " }}>
                        ...
                        <div className="subbox">
                            <ul>
                                ...
                                <li className="page_item"><a href="/">About</a></li>
                                <li className="page_item"><a href="/">Blog</a></li>
                                <li className="page_item"><a href="/">Cart</a></li>
                                <li className="page_item"><a href="/">Cart</a></li>
                                <li className="page_item"><a href="/">Checkout</a></li>
                                <li className="page_item"><a href="/">Checkout</a></li>
                                <li className="page_item"><a href="/">Contact</a></li>
                                <li className="page_item"><a href="/">My account</a></li>
                                <li className="page_item"><a href="/">My Account</a></li>
                                <li className="page_item"><a href="/">Sample Page</a></li>
                                <li className="page_item"><a href="/">Sample Page</a></li>
                                <li className="page_item"><a href="/">Sample Page</a></li>
                                <li className="page_item"><a href="/">Sample Page</a></li>
                                <li className="page_item"><a href="/">Shop</a></li>
                                <li className="page_item"><a href="/">Wishlist</a></li>
                            </ul>
                        </div>
                    </div>
